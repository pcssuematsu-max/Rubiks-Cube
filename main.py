...
def _default_initial_scramble_groups(size,puzzle_type):
    ...
    if puzzle_type == "megaminx":
        return (
            [
                ('R2', "sR'", 'R', 'F2', "R'", 'sR', 'R', "F2'", 'R2'),
                ('U2', 'sL2', "bL2'", 'bR', 'U', 'bL', "U'", "bL'", "bR'", "L'", "bL'", "U'", 'bL', 'U', 'L', 'bL2', "sL2'", "U2'"),
                ('F', "U'", "bR'", 'U', "F2'", "L'", 'F', "R2'", "F'", 'L', 'F', 'R2', "U'", 'bR', 'U'),
                ("L'", 'bL', 'L', "U2'", "bL'", "U2'", 'bL2', 'U', 'L', "U'", "L'", 'bL2', 'U', 'bL2', "U2'", "bL'"),
                ('F2', "R2'", "dL2'", 'F', 'dR', "F'", "dR'", "dL'", "R'", "dR'", "F'", 'dR', 'F', "R2'", "dL2'", "F2'"),
                ("L","U","F","U'","F'","L'","R'","F'","U'","F","U","R"),
                ("L", "U2", "F", "U'", "F'", "U'", "L'", "F", "R", "U", "R'", "U'", "F'"),
                ("R'", "F'", "U'", "F", "U", "R", "L", "U", "F", "U'", "F'", "L'"),
                ("F'", "U'", "L'", "U", "L", "F", "R'", "U'", "F'", "U'", "F", "U2", "R"),
                ("R'", "F'", 'R', "F'", "U'", 'F', 'U', 'F'),
                ('F', 'U', "F'", "U'", "F'", 'L', 'F', "L'"),
                ("U'", "bR2'", 'U', 'F', "U'", 'bR2', 'U', "F'"),
                ('L', 'U2', 'L', "U'", "L'", "U'", "L'"),
            ...
            [
                ('R', 'bR', "bL'", "bR2'", "R'", 'F', 'R', 'bR2', 'bL', "bR'", "R'", "F'"),
            ],
            [
                ("R'", "F'", 'L2', "F2'", "L'", 'F', 'L', 'F', "L2'", "bL'", "U'", "F'", 'U', 'F2', 'bL', 'R'),
            ],
            [],
            [],
            [],
