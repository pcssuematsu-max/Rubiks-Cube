    ...
    if puzzle_type == "megaminx":
        return (
            [
                ...
                ("L'", 'U', "bR'", "U'", 'L2', 'U', 'bR', "U'", "L'"),
                ("L", "U2", "F", "U'", "F'", "U'", "L'", "F", "R", "U", "R'", "U'", "F'"),
                ("F'", "L'", "bL'", "U'", "bR'", "U", "bR", "bL", "L'", "U'", "bL'", "U'", "bL", "U2", "L2", "F"),
                ("dR'", 'F', 'dR', "F'", "U'", 'F', "dR'", "F'", 'dR', 'U'),
                ('F', "U'", 'bR', 'U', "dR'", "F2'", "U'", "bR'", 'U', 'F2', 'dR', "F'"),
                ('dR', "sR'", "dR'", 'F', 'dR', 'sR', "dR'", "F'", "R2'", 'sR', "R'", "U2'", 'R', "sR'", "R'", 'U2', "R2'"),
                ('L2', 'F', "R'", "F'", "L2'", 'F', 'R', "F'"),
                ("U2'","F'","L","U","F","U'","F'","L'","R'","F'","U'","F","U","R","F","U2"),
                ("U2","F'","L","U","F","U'","F'","L'","R'","F'","U'","F","U","R","F","U2'"),
                ("R","U","R'"),
                ("F'","U","F"),
                ("R","U'","R'"),
                ...
                ("R'","U'","F","U","R","U'","R'","F'","R"),
                ("R'","F","R","U","R'","U'","F'","U","R"),
                ("U'", "R'", 'F', 'U', 'R', "U'", "R'", "F'", "bR'", "R'", "U'", 'R', 'U', 'bR', 'R', "U'", 'bR2', 'U', "bR'", "U'", "bR'", 'U2', 'F', 'R', 'bR', "R'", "F'", "bR'"),
                ('bR2', "U2'", "bR'", 'U', 'bR', 'U', "bR2'", "sR'", "R'", "U'", 'R', 'sR', "R'", 'F', 'U', 'R', "U'", "R'", "F'", "bR'", "R'", "U'", 'R', 'U', 'bR', 'R', 'U'),
                ("R'", 'U', "F'", "U2'", 'F', 'U', 'R', 'bR', "bL'", "bR'", "R'", 'bR', 'bL', "bR'", 'R', "F'", 'U', 'bL', "U'", 'F', 'U', "bL'", "U'"),
                ("R'", 'U', 'R', 'U', 'bR', 'bL', "U'", "bL2'", "bR'", 'F', 'R', 'bR', 'bL', "bR'", "R'", 'F2', 'L2', 'F', "L'", "F'", "L'", 'F2', 'R', 'U', 'L', "U'", "L'", "R'"),
            ],
            [
            ],
            [
